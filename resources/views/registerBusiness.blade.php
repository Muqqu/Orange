                        ...
                        <div class="col-lg-6">
                            <div class="wrapper">
                                <form action="{{ url('/payment') }}" method="post">
                                    ...
                                    <h1 class="title">Be the part<br>of <span class="text-primary">Our Family</span>
                                    </h1>
                                    ...
                                    <div id="cardDiv">
                                        <div class="input-wrapper">
                                            <input type="text" class="form-control" placeholder="Card Number"
                                                name="cardno" id="cardNumber">
                                        </div>
                                        <div class="input-wrapper">
                                            <input type="text" class="form-control" placeholder="Card Name"
                                                name="cardname" id="owner">
                                        </div>
                                        <div class="row credit-input">
                                            <div class="col-md-6">
                                                <div class="input-wrapper">
                                                    <input type="text" id="expirydate" name="expirydate"
                                                        class="form-control" placeholder="expiry date" maxlength="19">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-wrapper">
                                    ...
                                    <div id="jazzcashdiv" style="display:none">
                                        <div class="input-wrapper">
                                            <input type="text" class="form-control" placeholder="Jazzcash Phone"
                                                name="phone_no">
                                        </div>
                                    </div>
                                    <div id="easypaisaDiv" style="display:none">
                                        <div class="input-wrapper">
                                            <input type="text" class="form-control" placeholder="Easypasia Phone"
                                                name="phoneEasypaisa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-wrapper form-group radios-wrapper">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="creditCard"
