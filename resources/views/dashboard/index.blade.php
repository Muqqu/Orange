                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="video-player-wrapper"  >
                      ...
                      <video class="videoc" src="{{asset('assets/video/video-1.mp4')}}" controls muted ></video>
                    </div>
                  </div>
                  <div class="col-lg-4">
                        ...
                        <div class="accordion-item">
                          ...
                          <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#maindescription">
                            <div class="accordion-body">
                              <p class="text" id = "video-desc">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem, accusamus?</p>
                            </div>
                          </div>
                        </div>
                      </div>
