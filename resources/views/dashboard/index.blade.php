...
<body>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="video-player-wrapper">
                                        ...
                                        <video class="videoc" src="{{ asset('assets/video/video-1.mp4') }}" controls
                                            muted></video>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingOne">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        <h3 class="video-title" id="video-title">This is video</h3>
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show"
                                                    aria-labelledby="headingOne" data-bs-parent="#maindescription">
                                                    <div class="accordion-body">
                                                        <p class="text" id="video-desc">Lorem ipsum dolor sit amet
                                                            consectetur, adipisicing elit. Quidem, accusamus?</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        @foreach ($videos as $video)
                            <div class="col-lg-6">
                                ...
                                <a class="card video-card" id="videoplay" value="{{ $video->id }}">
                                    <img src="https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                                        alt="" class="card-img">
                                    <div class="card-body">
    ...
    <script>
        ...
        $(".video-card").on("click", function() {
            ...
            $.ajax({
                type: "GET",
                url: APP_URL_VIDEO + '/' + btnValue,
                check: "#counts" + btnValue,

                success: function(result) {
                    console.log("<video src ='" + result.video.video_url + "></video>");
                    $(".videoc").attr("src", result.video.video_url);
                    $("#video-title").html(result.video.title);
                    $("#video-desc").html(result.video.description);
                },
